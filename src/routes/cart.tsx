...
function CartPage() {
  ...
  const { locationName, pincode, address, isValid: isLocationValid } = useLocation();
  ...
  return (
    <div className="flex min-h-screen flex-col bg-background">
      ...
      {/* Delivery Bar */}
      <section className="bg-brand-soft/30 border-b">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-3">
          ...
          <button 
            ...
            className="flex items-center gap-1 rounded-full bg-card px-4 py-1 text-sm font-bold text-brand shadow-sm border border-border hover:text-primary transition-colors"
          >
            ...
            <div className="lg:col-span-1">
              <div className="sticky top-24 rounded-3xl border bg-card p-8 shadow-sm">
                ...
                <button
                  ...
                  className="w-full rounded-2xl bg-brand py-5 text-center text-sm font-black tracking-[0.2em] text-brand-foreground shadow-2xl shadow-brand/30 transition hover:bg-primary active:scale-[0.98] uppercase"
                >
                  Proceed to Payment
                </button>
